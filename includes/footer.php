...
?>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="footer-widget footer-social">
                            ...
                            <ul class="listnone">
                                <li><a href="https://www.facebook.com/share/1CvGaBSHNz/?mibextid=kFxxJD"> <i class="fa fa-facebook"></i> Facebook </a></li>
                                <li><a href="https://www.instagram.com/aditya_sirja?igsh=dWhnanl6YzFqZ2tu"> <i class="fa fa-instagram"></i> Instagram </a></li>
                                <li><a href="https://x.com/devil53539350?s=21"><i class="fa fa-twitter"></i> Twitter</a></li>
